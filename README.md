...
#define ldr_pin 34
char ssid[] = "OPPO A77s";   // your network SSID (name) 
char pass[] = "yuva2004";   // your network password
int keyIndex = 0;            // your network key Index number (needed only for WEP)
WiFiClient  client;

unsigned long myChannelNumber =  2750589;
const int ChannelField = 1;
const char * myWriteAPIKey = "2JD7P2D1G9LAMCWN";
...
```
# CIRCUIT DIAGRAM:
![387527949-ed9b0d27-f2cf-4c83-a41f-715705b28fab](https://github.com/user-attachments/assets/3ed476b4-2f8c-48da-9ffb-af427bb85496)

# OUTPUT:
![prt img 4](https://github.com/user-attachments/assets/10aaed15-9c0c-4a5d-9e8b-e96dec10ea70)
